                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('assets/snacks.png', fit: BoxFit.contain),
                    ),
                    SizedBox(width: 16),
                    Expanded(
                      child: Text(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('assets/breads.png', fit: BoxFit.contain),
                    ),
                    SizedBox(width: 16),
                    Expanded(
                      child: Text(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('assets/toys.png', fit: BoxFit.contain),
                    ),
                    SizedBox(width: 16),
                    Expanded(
                      child: Text(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('assets/toiletries.png',
                          fit: BoxFit.contain),
                    ),
                    SizedBox(width: 16),
                    Expanded(
