                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('assets/Sparkling_Berry_Juice.jpg',
                          fit: BoxFit.contain),
                    ),
                    SizedBox(width: 16),
                    Expanded(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('assets/burger.webp', fit: BoxFit.contain),
                    ),
                    SizedBox(width: 16),
                    Expanded(
                      child: Text(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('assets/march_7th.jpg', fit: BoxFit.contain),
                    ),
                    SizedBox(width: 16),
                    Expanded(
                      child: Text(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('assets/jellyfish_on_the_staircase.png', fit: BoxFit.contain),
                    ),
                    SizedBox(width: 16),
                    Expanded(
                      child: Text(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset('assets/Fortune_Glue.webp',
                          fit: BoxFit.contain),
                    ),
                    SizedBox(width: 16),
                    Expanded(
